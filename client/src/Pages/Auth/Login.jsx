...
const senddata =  async (event)=>{
  ...
  return (
    ...
    Welcome Back to Our Job Portal
  </h4>
  <p className="mb-4 text-sm">
  Log in to your account to. Whether you're seeking new opportunities, exploring career advancements, . Once logged in, you can seamlessly apply for positions, track your applications, and manage your profile with ease. Stay updated with the latest job openings, connect with potential employers, and take proactive steps towards your career goals
  </p>
                  </div>
                </div>
