...
function Signup() {
  ...
  return (
    <section className="gradient-form min-h-screen  flex   items-center  justify-center  dark:bg-neutral-700">
        ...
        <div className="flex h-full flex-wrap items-center justify-center text-neutral-800 dark:text-neutral-200">
          <div className="w-full">
            <div className="block rounded-lg bg-white shadow-lg dark:bg-neutral-800">
              ...
              <div
                  className="sm:flex  hidden   items-center rounded-b-lg lg:w-6/12 lg:rounded-e-lg lg:rounded-bl-none"
                  style={{
                    background:
                ...
                >
                  <div className="px-4 py-6 text-white md:mx-6 md:p-12">
                    ...
                    Welcome  to Our Job  Registration Portal
                    </h4>
                    <p className="text-sm">
                    Ready to take the next step in your career journey? Sign up now to unlock a world of opportunities on our job portal. Registration is quick and easy, allowing you to create a personalized profile that showcases your skills and experiences to potential employers. Gain access to a wide range of job listings tailored to your preferences and career aspirations
                    </p>
                  </div>
                </div>
